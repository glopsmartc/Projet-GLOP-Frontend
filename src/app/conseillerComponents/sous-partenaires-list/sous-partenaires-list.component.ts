...
@Component({
  selector: 'app-sous-partenaires-list',
  templateUrl: './sous-partenaires-list.component.html',
  standalone: true,
  imports: [CommonModule, FormsModule],
  styleUrls: ['./sous-partenaires-list.component.css']
})
export class SousPartenairesListComponent implements OnInit {
